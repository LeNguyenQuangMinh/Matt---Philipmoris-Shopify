class StickyNotification extends HTMLElement {
  ...
  calculateNotificationBottomPosition() {
    const toolbar = document.getElementById('section-sticky-notification-bar');
    if (!toolbar || !toolbar.querySelector('.sticky-toolbar-mobile')) return;
    const totalToolbarHeight = toolbar.querySelector('.sticky-toolbar-mobile').getBoundingClientRect().height + 'px';
